...
export const technicalSpecs = [
  { density: "451 - 550", gradeOne: "2.0", gradeTwo: "1.5", thermal: "0.21" },
  { density: "551 - 650", gradeOne: "4.0", gradeTwo: "3.0", thermal: "0.24" },
  { density: "651 - 750", gradeOne: "5.0", gradeTwo: "4.0", thermal: "0.30" },
  { density: "751 - 850", gradeOne: "6.0", gradeTwo: "5.0", thermal: "0.37" },
  { density: "851 - 1000", gradeOne: "7.0", gradeTwo: "6.0", thermal: "0.42" },
];
...
export const advantages = [
  {
    icon: "COST",
    title: "Cost Saving",
    desc: "66% lighter than conventional clay bricks. 25% less foundation load, 15% steel savings, 10% cement savings, 35% less plastering and labour costs, 40% overall structural cost reduction.",
  },
  {
    icon: "TIME",
    title: "Time Saving",
